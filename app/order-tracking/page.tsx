...
export default function OrderTrackingPage() {
    ...
    const handleLookup = async () => {
        ...
        if (!isObjectId(orderId.trim())) {
            setError('Order ID looks invalid. Please check and try again.');
            setLoading(false);
            return;
        }
            ...
            <div className="max-w-3xl mx-auto px-4">
                ...
                <div className="bg-white rounded-2xl shadow-sm p-6 mb-8">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="md:col-span-2">
                            ...
                            <input
                                ...
                                placeholder="e.g. 64a1f0b23c6d5e0012a34567"
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="mt-5 w-full md:w-auto bg-gray-900 text-white px-6 py-3 rounded-full font-semibold hover:bg-orange-600 transition"
                    >
